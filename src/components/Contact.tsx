  ...
  const contactInfo: ContactInfo[] = [
    {
      ...
      details: [
        'Plot No. 12, near Bharath petrol bunk, Rampally',
            ...
            {contactInfo.map((info, index) => {
              ...
              return (
                <CardWrapper
                  ...
                  className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 block cursor-pointer"
                >
